...
local root = "/software.el7/software/Autoconf/2.69-GCCcore-6.4.0"
...
if not isloaded("M4/.1.4.18-GCCcore-6.4.0") then
    load("M4/.1.4.18-GCCcore-6.4.0")
end
...
setenv("EBDEVELAUTOCONF", pathJoin(root, "easybuild/Autoconf-.2.69-GCCcore-6.4.0-easybuild-devel"))
