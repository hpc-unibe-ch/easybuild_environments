...
local root = "/software.el7/software/Autoconf/2.69-GCCcore-7.3.0"
...
setenv("EBDEVELAUTOCONF", pathJoin(root, "easybuild/Autoconf-.2.69-GCCcore-7.3.0-easybuild-devel"))
