...
local root = "/software.el7/software/Automake/1.16.1-GCCcore-7.3.0"
...
setenv("EBDEVELAUTOMAKE", pathJoin(root, "easybuild/Automake-.1.16.1-GCCcore-7.3.0-easybuild-devel"))
