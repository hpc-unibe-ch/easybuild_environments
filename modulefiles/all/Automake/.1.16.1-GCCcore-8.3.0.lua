...
local root = "/software.el7/software/Automake/1.16.1-GCCcore-8.3.0"
...
setenv("EBDEVELAUTOMAKE", pathJoin(root, "easybuild/Automake-.1.16.1-GCCcore-8.3.0-easybuild-devel"))
