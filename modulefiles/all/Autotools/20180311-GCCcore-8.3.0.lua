...
local root = "/software.el7/software/Autotools/20180311-GCCcore-8.3.0"
...
if not ( isloaded("Automake/.1.16.1-GCCcore-8.3.0") ) then
    load("Automake/.1.16.1-GCCcore-8.3.0")
end
...
setenv("EBDEVELAUTOTOOLS", pathJoin(root, "easybuild/Autotools-20180311-GCCcore-8.3.0-easybuild-devel"))
