...
local root = "/software.el7/software/Bison/3.0.5-GCCcore-8.2.0"
...
setenv("EBVERSIONBISON", "3.0.5")
setenv("EBDEVELBISON", pathJoin(root, "easybuild/Bison-.3.0.5-GCCcore-8.2.0-easybuild-devel"))
