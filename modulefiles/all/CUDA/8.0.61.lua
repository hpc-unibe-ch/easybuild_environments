...
local root = "/software.el7/software/CUDA/8.0.61"
...
setenv("EBDEVELCUDA", pathJoin(root, "easybuild/CUDA-8.0.61-easybuild-devel"))

setenv("CUDA_HOME", "/software.el7/software/CUDA/8.0.61")
