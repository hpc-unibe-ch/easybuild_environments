...
local root = "/software.el7/software/EasyBuild/3.9.1"

conflict("EasyBuild")

prepend_path("PATH", pathJoin(root, "bin"))
setenv("EBROOTEASYBUILD", root)
setenv("EBVERSIONEASYBUILD", "3.9.1")
setenv("EBDEVELEASYBUILD", pathJoin(root, "easybuild/EasyBuild-3.9.1-easybuild-devel"))
