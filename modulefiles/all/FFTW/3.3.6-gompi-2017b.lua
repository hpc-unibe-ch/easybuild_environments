...
local root = "/software.el7/software/FFTW/3.3.6-gompi-2017b"
...
setenv("EBVERSIONFFTW", "3.3.6")
setenv("EBDEVELFFTW", pathJoin(root, "easybuild/FFTW-3.3.6-gompi-2017b-easybuild-devel"))
