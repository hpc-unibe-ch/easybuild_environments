...
local root = "/software.el7/software/FFTW/3.3.7-intel-2017b"

conflict("FFTW")

if not isloaded("intel/2017b") then
    load("intel/2017b")
end
...
setenv("EBDEVELFFTW", pathJoin(root, "easybuild/FFTW-3.3.7-intel-2017b-easybuild-devel"))
