...
local root = "/software.el7/software/FFTW/3.3.7-intel-2018a"

conflict("FFTW")

if not isloaded("intel/2018a") then
    load("intel/2018a")
end
...
setenv("EBDEVELFFTW", pathJoin(root, "easybuild/FFTW-3.3.7-intel-2018a-easybuild-devel"))
