...
local root = "/software.el7/software/FFTW/3.3.8-iomkl-2018b"

conflict("FFTW")

if not isloaded("iomkl/2018b") then
    load("iomkl/2018b")
end
...
setenv("EBDEVELFFTW", pathJoin(root, "easybuild/FFTW-3.3.8-iomkl-2018b-easybuild-devel"))
