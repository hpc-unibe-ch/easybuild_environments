...
local root = "/software.el7/software/OpenMPI/2.1.1-iccifort-2017.4.196-GCC-6.4.0-2.28"
...
if not isloaded("hwloc/1.11.7-GCCcore-6.4.0") then
    load("hwloc/1.11.7-GCCcore-6.4.0")
end
...
setenv("EBDEVELOPENMPI", pathJoin(root, "easybuild/OpenMPI-2.1.1-iccifort-2017.4.196-GCC-6.4.0-2.28-easybuild-devel"))
