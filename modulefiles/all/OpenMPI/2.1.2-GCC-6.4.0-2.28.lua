...
local root = "/software.el7/software/OpenMPI/2.1.2-GCC-6.4.0-2.28"
...
setenv("EBDEVELOPENMPI", pathJoin(root, "easybuild/OpenMPI-2.1.2-GCC-6.4.0-2.28-easybuild-devel"))
