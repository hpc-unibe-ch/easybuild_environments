...
local root = "/software.el7/software/OpenMPI/3.1.1-GCC-7.3.0-2.30"
...
setenv("EBDEVELOPENMPI", pathJoin(root, "easybuild/OpenMPI-3.1.1-GCC-7.3.0-2.30-easybuild-devel"))
