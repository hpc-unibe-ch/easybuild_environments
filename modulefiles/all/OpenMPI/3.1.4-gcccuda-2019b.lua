...
local root = "/software.el7/software/OpenMPI/3.1.4-gcccuda-2019b"

conflict("OpenMPI")

if not ( isloaded("gcccuda/2019b") ) then
    load("gcccuda/2019b")
end
...
setenv("EBDEVELOPENMPI", pathJoin(root, "easybuild/OpenMPI-3.1.4-gcccuda-2019b-easybuild-devel"))
