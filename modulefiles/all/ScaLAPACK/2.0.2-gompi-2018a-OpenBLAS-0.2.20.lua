...
local root = "/software.el7/software/ScaLAPACK/2.0.2-gompi-2018a-OpenBLAS-0.2.20"
...
setenv("EBDEVELSCALAPACK", pathJoin(root, "easybuild/ScaLAPACK-2.0.2-gompi-2018a-OpenBLAS-0.2.20-easybuild-devel"))
