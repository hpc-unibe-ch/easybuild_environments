...
local root = "/software.el7/software/ScaLAPACK/2.0.2-gompi-2019a-OpenBLAS-0.3.5"
...
setenv("EBDEVELSCALAPACK", pathJoin(root, "easybuild/ScaLAPACK-2.0.2-gompi-2019a-OpenBLAS-0.3.5-easybuild-devel"))
