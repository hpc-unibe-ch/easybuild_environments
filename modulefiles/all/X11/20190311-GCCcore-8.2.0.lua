...
local root = "/software.el7/software/X11/20190311-GCCcore-8.2.0"
...
if not ( isloaded("fontconfig/.2.13.1-GCCcore-8.2.0") ) then
    load("fontconfig/.2.13.1-GCCcore-8.2.0")
end
...
setenv("EBDEVELX11", pathJoin(root, "easybuild/X11-20190311-GCCcore-8.2.0-easybuild-devel"))
