...
local root = "/software.el7/software/binutils/2.30-GCCcore-7.3.0"
...
setenv("EBDEVELBINUTILS", pathJoin(root, "easybuild/binutils-.2.30-GCCcore-7.3.0-easybuild-devel"))
