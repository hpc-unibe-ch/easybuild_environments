...
local root = "/software.el7/software/binutils/2.31.1-GCCcore-8.2.0"
...
setenv("EBDEVELBINUTILS", pathJoin(root, "easybuild/binutils-.2.31.1-GCCcore-8.2.0-easybuild-devel"))
