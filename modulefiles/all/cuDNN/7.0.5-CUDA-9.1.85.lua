...
local root = "/software.el7/software/cuDNN/7.0.5-CUDA-9.1.85"

conflict("cuDNN")

if not isloaded("CUDA/9.1.85") then
    load("CUDA/9.1.85")
end
...
setenv("EBDEVELCUDNN", pathJoin(root, "easybuild/cuDNN-7.0.5-CUDA-9.1.85-easybuild-devel"))
