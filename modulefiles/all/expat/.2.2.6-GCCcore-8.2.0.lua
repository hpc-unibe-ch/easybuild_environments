...
local root = "/software.el7/software/expat/2.2.6-GCCcore-8.2.0"
...
setenv("EBVERSIONEXPAT", "2.2.6")
setenv("EBDEVELEXPAT", pathJoin(root, "easybuild/expat-.2.2.6-GCCcore-8.2.0-easybuild-devel"))
