...
local root = "/software.el7/software/gettext/0.19.8.1-GCCcore-6.4.0"
...
if not isloaded("libxml2/.2.9.4-GCCcore-6.4.0") then
    load("libxml2/.2.9.4-GCCcore-6.4.0")
end
...
setenv("EBDEVELGETTEXT", pathJoin(root, "easybuild/gettext-.0.19.8.1-GCCcore-6.4.0-easybuild-devel"))
