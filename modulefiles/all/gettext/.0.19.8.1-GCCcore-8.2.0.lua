...
local root = "/software.el7/software/gettext/0.19.8.1-GCCcore-8.2.0"
...
setenv("EBDEVELGETTEXT", pathJoin(root, "easybuild/gettext-.0.19.8.1-GCCcore-8.2.0-easybuild-devel"))
