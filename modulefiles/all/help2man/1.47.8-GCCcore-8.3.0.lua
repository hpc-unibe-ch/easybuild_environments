...
local root = "/software.el7/software/help2man/1.47.8-GCCcore-8.3.0"
...
setenv("EBVERSIONHELP2MAN", "1.47.8")
setenv("EBDEVELHELP2MAN", pathJoin(root, "easybuild/help2man-1.47.8-GCCcore-8.3.0-easybuild-devel"))
