...
local root = "/software.el7/software/hwloc/1.11.11-GCCcore-8.2.0"
...
if not ( isloaded("libpciaccess/.0.14-GCCcore-8.2.0") ) then
    load("libpciaccess/.0.14-GCCcore-8.2.0")
end
...
setenv("EBDEVELHWLOC", pathJoin(root, "easybuild/hwloc-1.11.11-GCCcore-8.2.0-easybuild-devel"))
