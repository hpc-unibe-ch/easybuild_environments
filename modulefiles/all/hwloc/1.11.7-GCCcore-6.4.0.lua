...
local root = "/software.el7/software/hwloc/1.11.7-GCCcore-6.4.0"
...
setenv("EBVERSIONHWLOC", "1.11.7")
setenv("EBDEVELHWLOC", pathJoin(root, "easybuild/hwloc-1.11.7-GCCcore-6.4.0-easybuild-devel"))
