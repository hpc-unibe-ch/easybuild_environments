...
local root = "/software.el7/software/iccifort/2017.4.196-GCC-6.4.0-2.28"
...
setenv("EBVERSIONICCIFORT", "2017.4.196")
setenv("EBDEVELICCIFORT", pathJoin(root, "easybuild/iccifort-2017.4.196-GCC-6.4.0-2.28-easybuild-devel"))
