...
local root = "/software.el7/software/imkl/2018.1.163-iimpi-2018a"

conflict("imkl")

if not isloaded("iimpi/2018a") then
    load("iimpi/2018a")
end
...
setenv("EBDEVELIMKL", pathJoin(root, "easybuild/imkl-2018.1.163-iimpi-2018a-easybuild-devel"))

setenv("MKL_EXAMPLES", "/software.el7/software/imkl/2018.1.163-iimpi-2018a/mkl/examples/")
prepend_path("NLSPATH", pathJoin(root, "idb/intel64/locale/%l_%t/%N"))
setenv("MKLROOT", "/software.el7/software/imkl/2018.1.163-iimpi-2018a/mkl")
