...
local root = "/software.el7/software/imkl/2018.3.222-iimpi-2018b"

conflict("imkl")

if not isloaded("iimpi/2018b") then
    load("iimpi/2018b")
end
...
setenv("EBDEVELIMKL", pathJoin(root, "easybuild/imkl-2018.3.222-iimpi-2018b-easybuild-devel"))

setenv("MKL_EXAMPLES", "/software.el7/software/imkl/2018.3.222-iimpi-2018b/mkl/examples/")
prepend_path("NLSPATH", pathJoin(root, "idb/intel64/locale/%l_%t/%N"))
setenv("MKLROOT", "/software.el7/software/imkl/2018.3.222-iimpi-2018b/mkl")
