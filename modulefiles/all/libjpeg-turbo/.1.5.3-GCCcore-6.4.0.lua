...
local root = "/software.el7/software/libjpeg-turbo/1.5.3-GCCcore-6.4.0"
...
if not isloaded("NASM/.2.13.03-GCCcore-6.4.0") then
    load("NASM/.2.13.03-GCCcore-6.4.0")
end
...
setenv("EBDEVELLIBJPEGMINTURBO", pathJoin(root, "easybuild/libjpeg-turbo-.1.5.3-GCCcore-6.4.0-easybuild-devel"))
