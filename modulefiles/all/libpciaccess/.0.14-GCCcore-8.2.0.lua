...
local root = "/software.el7/software/libpciaccess/0.14-GCCcore-8.2.0"
...
setenv("EBDEVELLIBPCIACCESS", pathJoin(root, "easybuild/libpciaccess-.0.14-GCCcore-8.2.0-easybuild-devel"))
