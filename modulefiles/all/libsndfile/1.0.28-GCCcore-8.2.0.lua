...
local root = "/software.el7/software/libsndfile/1.0.28-GCCcore-8.2.0"
...
setenv("EBDEVELLIBSNDFILE", pathJoin(root, "easybuild/libsndfile-1.0.28-GCCcore-8.2.0-easybuild-devel"))
