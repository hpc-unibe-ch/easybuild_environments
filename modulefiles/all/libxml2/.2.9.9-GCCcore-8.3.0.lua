...
local root = "/software.el7/software/libxml2/2.9.9-GCCcore-8.3.0"
...
setenv("EBVERSIONLIBXML2", "2.9.9")
setenv("EBDEVELLIBXML2", pathJoin(root, "easybuild/libxml2-.2.9.9-GCCcore-8.3.0-easybuild-devel"))
