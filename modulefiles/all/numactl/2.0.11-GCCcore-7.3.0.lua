...
local root = "/software.el7/software/numactl/2.0.11-GCCcore-7.3.0"
...
setenv("EBDEVELNUMACTL", pathJoin(root, "easybuild/numactl-2.0.11-GCCcore-7.3.0-easybuild-devel"))
