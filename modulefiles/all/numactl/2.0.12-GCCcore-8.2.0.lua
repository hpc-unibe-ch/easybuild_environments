...
local root = "/software.el7/software/numactl/2.0.12-GCCcore-8.2.0"
...
setenv("EBDEVELNUMACTL", pathJoin(root, "easybuild/numactl-2.0.12-GCCcore-8.2.0-easybuild-devel"))
