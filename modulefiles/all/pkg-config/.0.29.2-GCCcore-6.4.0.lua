...
local root = "/software.el7/software/pkg-config/0.29.2-GCCcore-6.4.0"
...
setenv("EBDEVELPKGMINCONFIG", pathJoin(root, "easybuild/pkg-config-.0.29.2-GCCcore-6.4.0-easybuild-devel"))
